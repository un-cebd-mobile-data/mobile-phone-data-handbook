...
Dynamic Population Mapping uses MPD to estimate where people are located at different times of day or year, capturing the ***de facto*** **population** rather than the static, *de jure* population recorded in censuses. This approach captures the actual presence and movement of populations over time. [@uncebd_dynamic_population]
...
Case studies, particularly from Latin America and Europe, have demonstrated the strong value of MPD, highlighting improvements in the quality, spatial coverage, and temporal continuity of mobility statistics, as well as the ability to analyse mobility patterns over multiple days and time periods. [@caceres2007origin_destination]
