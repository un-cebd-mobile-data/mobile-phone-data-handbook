...
MPD can help to overcome some of the common limitations of tourism surveys by capturing cross-border and short-duration movements. [@uncebd_tourism_statistics] The specific ways in which MPD can be used for tourism statistics and data include:
...
Case studies, particularly from Latin America and Europe, have demonstrated the strong value of MPD, highlighting improvements in the quality, spatial coverage, and temporal continuity of mobility statistics, as well as the ability to analyse mobility patterns over multiple days and time periods. [@caceres2007origin_destination; @alexander2015od]
