...
Two broad categories of sensitive information commonly arise. The first is personal data, such as individual-level CDR trajectories, which can reveal patterns of movement even when direct identifiers are removed. The second is commercially sensitive information, such as detailed network infrastructure data, which MNOs may need to protect for competitive or security reasons [@demontjoye2013unique; @demontjoye2018privacy].
